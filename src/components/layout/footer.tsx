...
const BRAND_PATHS: Record<string, string> = {
  ...
  mail: "M1.5 5.25A2.25 2.25 0 0 1 3.75 3h16.5a2.25 2.25 0 0 1 2.25 2.25v13.5A2.25 2.25 0 0 1 20.25 21H3.75a2.25 2.25 0 0 1-2.25-2.25V5.25zm2.06.45 8.44 6.33 8.44-6.33H3.56zM21 7.06l-8.4 6.3a1 1 0 0 1-1.2 0L3 7.06v11.69h18V7.06z",
  website:
    "M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm7.918 7h-3.04a15.6 15.6 0 0 0-1.32-3.36A8.03 8.03 0 0 1 19.918 7zM12 2.04c.83 1.2 1.48 2.53 1.92 3.96h-3.84A13.6 13.6 0 0 1 12 2.04zM2.26 14a7.96 7.96 0 0 1 0-4h3.48a16.5 16.5 0 0 0 0 4H2.26zm.82 2h3.04a15.6 15.6 0 0 0 1.32 3.36A8.03 8.03 0 0 1 3.08 16zm3.04-9H3.08a8.03 8.03 0 0 1 4.36-3.36A15.6 15.6 0 0 0 6.12 7zM12 21.96c-.83-1.2-1.48-2.53-1.92-3.96h3.84A13.6 13.6 0 0 1 12 21.96zM14.34 16H9.66a14.4 14.4 0 0 1 0-4h4.68a14.4 14.4 0 0 1 0 4zm.26 3.36A15.6 15.6 0 0 0 15.92 16h3.04a8.03 8.03 0 0 1-4.36 3.36zM18.26 14a16.5 16.5 0 0 0 0-4h3.48a7.96 7.96 0 0 1 0 4h-3.48z",
};

function SocialIcon({ platform }: { platform: string }) {
  const path = BRAND_PATHS[platform] ?? BRAND_PATHS.website;
  return (
    <svg
      viewBox="0 0 24 24"
      width="18"
